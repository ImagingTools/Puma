...
LIBS += -L$(IMTCOREDIR)/Lib/$$COMPILER_DIR -limtbase -limtmail -limtdb -limtgui -limtqml -limtlog -limtloggui -limtstyle -limtrest -limtlic -lImtCoreLoc -limtcrypt -limtauth -limtaccount -limtauthgql -limtbase -limtgql -limtauthdb -limtcom -limtauthsdl -limtcol -limtbasesdl
LIBS += -L$(IMTCOREDIR)/Lib/$$COMPILER_DIR -limtlicgql -limtguigql -limtapp -limtclientgql -limtservice -limtservergql -limtbasesdl -limtserverapp -limtchat
...
!macx-ios*{
	mac{
	#	ICON += $$PWD/../Mac/PumaServerPg.icns
...
ARXC_FILES += $$PWD/../PumaServerPg.acc
ARXC_OUTDIR = $$OUT_PWD/$$AUXINCLUDEPATH/GeneratedFiles/$$TARGET

# Conversion of resource templates:
win*{
# File transformation
	# ACF_CONVERT_FILES = $$PWD/../VC/PumaServerPg.rc.xtracf
...
# RC_FILE = $$OUT_PWD/$$AUXINCLUDEPATH/GeneratedFiles/$$TARGET/PumaServerPg.rc
