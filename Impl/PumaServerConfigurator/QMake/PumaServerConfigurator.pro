...
LIBS += -limtbase -limtgui -limtstyle -limtqml -limtstyleqml -limtfile -limtgql -limtcom -limtdb -limtapp
LIBS += -lImtCoreLoc
LIBS += -lpumaqml
...
win32-msvc*{
	...
	greaterThan(QT_MAJOR_VERSION, 4): QMAKE_POST_LINK = set path=$(QTDIR)\bin;%path% && $(QTDIR)\bin\windeployqt --qmldir=$(PUMADIR)/Impl/PumaServerConfigurator --qmldir=$(IMTCOREDIR)/Include/imtqml/Resources/qml --qmldir=$(IMTCOREDIR)/Include/imtgui/Qml/imtgui $$DESTDIR
}
