...
Source: "{#BasePath}\*"; Excludes: "*.exe,*.manifest,*.pdb";  DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\Session Manager\Environment"; \
    ValueType: expandsz; ValueName: "Path"; ValueData: "{olddata};{pf64}\PostgreSQL\17\bin"; \
    Tasks:  envPath; Check: NeedsAddPath('{pf64}\PostgreSQL\17\bin');
