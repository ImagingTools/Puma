#include "CAddUserControllerTest.h"
...
imtbase::CTreeItemModel* CAddUserControllerTest::CreateExpectedModel() const
{
	...
	imtbase::CTreeItemModel* addedModelPtr = dataModelPtr->AddTreeModel("addedNotification");
	Q_ASSERT(addedModelPtr != nullptr);

	addedModelPtr->SetData("Id", "Test");
	addedModelPtr->SetData("Name", "Test");

	return expectedModelPtr.PopPtr();
}


imtgql::CGqlRequest* CAddUserControllerTest::CreateGqlRequest() const
{
	...
	QByteArray json = QString(R"({"Username": "Test", "Mail": "" ,"Name": "Test", "Description": "Test", "Password": "1"})").toUtf8();
...
bool CAddUserControllerTest::VerifyResponse(const imtbase::CTreeItemModel& /*actualModel*/, const imtbase::CTreeItemModel& /*expectedModel*/) const
{
...
I_ADD_TEST(CAddUserControllerTest);
